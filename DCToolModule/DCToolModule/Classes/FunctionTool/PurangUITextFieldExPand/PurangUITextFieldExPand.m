...
#import "PurangUITextFieldExPand.h"
#import "UIView+view.h"
#import "UITextField+BXExtension.h"
#import "PRBaseHeader.h"

@interface PurangUITextFieldExPand ()
/** X按钮 */
...
@implementation PurangUITextFieldExPand
...
- (void)keyboardWillShow:(NSNotification *)notification {
    ...
    kbHeight -= KStatusBottomBarHeight;
    // 动画的轨迹
    NSInteger animationCurve = [[userInfo objectForKey:UIKeyboardAnimationCurveUserInfoKey] integerValue];
    ...
    UIButton *doneButton = [[UIButton alloc] initWithFrame:CGRectMake(doneButtonX, doneButtonY-KStatusBottomBarHeight, doneButtonW, doneButtonH)];
    doneButton.titleLabel.font = [UIFont systemFontOfSize:27];
    [doneButton setTitle:_placeText forState:(UIControlStateNormal)];
